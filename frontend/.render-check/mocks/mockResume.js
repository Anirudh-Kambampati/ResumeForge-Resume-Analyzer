...
exports.mockResume = {
    ...
    summary: {
        id: "summary",
        enabled: true,
        text: "Software Engineer with 5+ years of experience building scalable web applications, cloud-native systems, and delightful user experiences.",
    },
    experience: [
        {
            id: "exp-google",
    ...
    achievements: [
        {
            ...
            description: "Won first place among 250+ teams for building an AI productivity platform.",
        },
    ],
    certifications: [
        {
